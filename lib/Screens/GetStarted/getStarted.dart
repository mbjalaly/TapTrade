      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Image.asset("assets/images/icon2.png",height: isTab ? Get.height * 0.5 : null,),
              ...
              if(Platform.isAndroid)...{
                ...
                GestureDetector(
                  onTap: (){
                    AppleAuthService.instance.apple(context: context);
                    // Get.to(PhoneSignInScreen());
                  },
                  child: Container(
                    height: Get.height*0.071,
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            width: Get.width * 0.6,
                            child: AppText(text: "LOG IN WITH APPLE",
                              fontSize: Get.width*0.042,
                              textcolor: Colors.black,
                            ),
                          ),
