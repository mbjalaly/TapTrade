                        ...
                        onPressed: () async {
                          try {
                            ...
                            if (tradeResponseModel != null && (success ?? false)) {
                              String traderId = ((tradeResponseModel.otherProduct?.user ?? "") == userController.userProfile.value.data?.id ? tradeResponseModel.userProduct?.user : tradeResponseModel.otherProduct?.user) ?? "";
