                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          itemCount: tradeList
                              .length, // Adjust to the number of items you want to display
                          itemBuilder: (context, index) {
                            TradeRequestUserProduct otherProduct =
                                tradeList[index].otherProduct ??
                                    TradeRequestUserProduct();
                            TradeRequestUserProduct userProduct =
                                tradeList[index].userProduct ??
                                    TradeRequestUserProduct();
                            return GestureDetector(
                              onTap: (){
                                ProfileService.instance.traderProfile(context,(otherProduct.user ?? '').toString());
