...
class LikedDealScreen extends StatefulWidget {
  const LikedDealScreen({Key? key}) : super(key: key);

  @override
  _LikedDealScreenState createState() => _LikedDealScreenState();
}

class _LikedDealScreenState extends State<LikedDealScreen> {
  ...
  getData() async {
    try {
      ...
      if (id.isNotEmpty) {
        final result = await ProductService.instance.getLikeProduct(context, id);
      }
    } catch (e) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount: likeList.length, // Adjust to the number of items you want to display
                    itemBuilder: (context, index) {
                      LikeUserProduct otherProduct = likeList[index].otherProduct ?? LikeUserProduct();
                      LikeUserProduct userProduct = likeList[index].userProduct ?? LikeUserProduct();
                      return GestureDetector(
                        onTap: () {
                          Get.to( () => MatchDealScreen(isDirect: false, likeData: likeList[index], matchData: null, tradeRequestData: null,));
                        },
                        child: Container(
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image:  DecorationImage(
                                          image: NetworkImage((userProduct.image ?? '')),
                                          fit: BoxFit.fill,
                                        ),
                                      ),
                                    ),
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: Colors.green,
                                          image:  DecorationImage(
                                            image: NetworkImage((otherProduct.image ?? '')),
                                            fit: BoxFit.fill,
                                          ),
                                        ),
                                      ),
