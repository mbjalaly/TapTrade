  ...
  static Future<void> google({required BuildContext context}) async {
    try {
      ...
      if (!internet) {
        ...
        print("No Internet Connection");
        ShowMessage.notify(context, "No internet connection.");
        return;
      }
      ...
      if (googleSignInAccount == null) {
        AppLoadingPopup.hide();
        print("Google sign-in was canceled or failed.");
        ShowMessage.notify(context, "Google sign-in cancelled.");
        return;
      }
      ...
      if (credential.idToken == null) {
        AppLoadingPopup.hide();
        print("Firebase idToken is null");
        ShowMessage.notify(context, "Something went wrong with Google Sign-In.");
        return;
      }
      ...
      if (user == null) {
        AppLoadingPopup.hide();
        ShowMessage.notify(context, "Google Sign-In failed.");
        return;
      }
      ...
      AppLoadingPopup.hide();
      print("An error occurred during Google Sign-In: $e");
      ShowMessage.notify(context, "Google Sign-In failed. Please try again.");
    }
  }
